...
def rules():
        ...
        time.sleep(4)
        print("3. The goal of the game is to draw cards until you get a sum up to 21 - However, going above this limit results in a loss for you and a win for the dealer, and vice versa.")
        time.sleep(4)
